        ...
        <div className="bg-gradient-to-r from-green-200 via-green-50 to-green-200 py-36 w-full h-screen">
          <div className="flex flex-row">
            ...
            <div className="container flex flex-col gap-4 w-5/12 pr-28 py-12">
                ...
                <h1 className="text-4xl font-bold text-gray-800">Technical Entrepreneur</h1>
            ...
            <div className="container flex flex-col gap-6 w-2/12 py-4">
                <img src="HomeImages/icons8-lightbulb.svg" alt="Lightbulb" className="w-20 h-20" />
                <img src="HomeImages/icons8-strong-96.png" alt="Strong" className="w-20 h-20" />
                <img src="HomeImages/icons8-gears-96.png" alt="Gears" className="w-20 h-20" />
                <img src="HomeImages/icons8-mountain-96.png" alt="Mountain" className="w-20 h-20" />
            </div>
          </div>
          <div className="flex flex-row gap-8 justify-center mt-4">
            ...
            <LinkButton srcPath="HomeImages/icons8-github-60.png" altText="GitHub"m url="https://github.com/HunterKnott" position="w-14 h-14"/>
            <LinkButton srcPath="HomeImages/icons8-paper-airplane-50.png" altText="Email" url="mailto:hunterknott00@gmail.com" position="w-10 h-10 pr-1"/>
