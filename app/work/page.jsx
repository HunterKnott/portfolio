                    ...
                    <ul className="w-1/2 flex flex-col gap-10 py-6">
                        ...
                        <li><Skill
                            ...
                            experience={[{ type: "Python", icons: [{ path: "ProjectIcons/NumPy.svg", text: "NumPy is helpful for all sorts of math operations. It's been especially helpful in performing linear algrabra for making machine learning models." },
                                        ...
                                        { type: "Topics", icons: [{ path: "ProjectIcons/Calculus.png", text: "I took all my calculus classes as a university student. Multivariable calculus wa fascinating, especially how it related to the physical world." },
                                                                ...
                                                                { path: "ProjectIcons/MachineLearning.png", text: "All my education in Data Science seems to point towards Machine Learning and its vast potential in the future. As Artificial Intelligence becomes more prevalent, understand it will be a great asset." },] }
                                    ]}
                        /></li>
                    </ul>
                </div>
